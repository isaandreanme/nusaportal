...
<head>
    ...
    <title>Hongkong - {{ env('COMPANY_NAME') }}</title>
    ...
    <table class="header-table" width="100%" style="border-collapse: collapse;">
        <tr>
            ...
            <td width="33%" style="text-align: center;">
                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/hongkong.png'))) }}" alt="Hongkong" width="100">
            </td>
