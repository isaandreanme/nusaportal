...
<head>
    ...
    <title>Taiwan - {{ env('COMPANY_NAME') }}</title>
    ...
    <table class="header-table" width="100%" style="border-collapse: collapse;">
        <tr>
            ...
            <td width="33%" style="text-align: center;">
                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/taiwan.png'))) }}" alt="Taiwan" width="100">
            </td>

            <!-- Right: Code Section -->
            <td width="33%" style="text-align: right;">
                <div>
                    <p><strong>Code:</strong> {{ $marketing->code_hk ?? '-' }}</p>
