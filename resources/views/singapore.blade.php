...
<head>
    ...
    <title>Singapore - {{ env('COMPANY_NAME') }}</title>
...
<body>
    ...
    <table class="header-table" width="100%" style="border-collapse: collapse;">
        <tr>
            ...
            <!-- Center: Singapore PNG -->
            <td width="33%" style="text-align: center;">
                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/singapore.png'))) }}" alt="Singapore" width="100">
            </td>

            <!-- Right: Code Section -->
            <td width="33%" style="text-align: right;">
                <div>
                    <p><strong>Code:</strong> {{ $marketing->code_sgp ?? '-' }}</p>
